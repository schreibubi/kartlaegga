...
import org.schreibubi.kartlägga.extend.LinkedHashMap;
import org.schreibubi.kartlägga.extend.LinkedHashMap.KeyIterator;

/**
 * @author joerg
 * 
 */
public class LRUMemoryCache extends AbstractLRUCache {
	...
	public LRUMemoryCache(LRUCacheInterface child) {
		super(child);
	}
